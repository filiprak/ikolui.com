...
<script setup>
import { IkSkeletonListItem } from '@ikol/ui-kit/components/IkSkeletonListItem';
</script>
```
...
<template>
  <div style="border: 1px solid var(--border-neutral-regular-default); border-radius: 8px; padding: 16px; max-width: 300px;">
    <IkSkeleton active :size_px="120" round class="ik-mb-4" />
    <IkSkeleton active size="lg" :width="100" class="ik-mb-2" />
    <IkSkeleton active size="sm" :width="80" class="ik-mb-2" />
...
<template>
  <div style="border: 1px solid var(--border-neutral-regular-default); border-radius: 8px; padding: 16px;">
    <div class="ik-flex ik-gap-4 ik-mb-4">
      <IkSkeleton active :width="20" />
      <IkSkeleton active :width="30" />
      <IkSkeleton active :width="25" />
      <IkSkeleton active :width="25" />
    </div>
    <div class="ik-flex ik-flex-col ik-gap-3">
      <div class="ik-flex ik-gap-4">
        <IkSkeleton active :width="20" />
        <IkSkeleton active :width="30" />
        <IkSkeleton active :width="25" />
...
<template>
  <div style="border: 1px solid var(--border-neutral-regular-default); border-radius: 8px; padding: 16px; max-width: 400px;">
    <div class="ik-flex ik-gap-4 ik-mb-4">
      ...
      <div class="ik-flex-1 ik-flex ik-flex-col ik-gap-2">
        <IkSkeleton active size="lg" :width="70" />
        <IkSkeleton active size="sm" :width="50" />
      </div>
    </div>
    <IkSkeleton active :width="100" class="ik-mb-2" />
    <IkSkeleton active :width="100" class="ik-mb-2" />
