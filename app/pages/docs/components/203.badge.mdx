...
```vue title="[[_Source code_]]" preview
<template>
  <div class="ik-flex ik-gap-4 ik-items-center">
    <IkBadge :number="3">
...
```vue title="[[_Source code_]]" preview
<template>
  <div class="ik-flex ik-gap-4 ik-items-center ik-flex-wrap">
    <IkBadge design="primary" :number="5">
      <IkButton>Primary</IkButton>
    </IkBadge>
    <IkBadge design="success" :number="3">
      <IkButton>Success</IkButton>
    </IkBadge>
    <IkBadge design="error" :number="12">
      <IkButton>Error</IkButton>
    </IkBadge>
    <IkBadge design="accent" :number="7">
...
<template>
  <div class="ik-flex ik-gap-4 ik-items-center ik-flex-wrap">
    ...
    <IkBadge :number="3" top>
      <IkButton>Top Right</IkButton>
    </IkBadge>
    <IkBadge :number="3" left>
...
<template>
  <div class="ik-flex ik-gap-4 ik-items-center ik-flex-wrap">
    <IkBadge :size="8" :number="3">
      <IkButton>Small (8px)</IkButton>
    </IkBadge>
    <IkBadge :size="12" :number="3">
      <IkButton>Default (12px)</IkButton>
    </IkBadge>
    <IkBadge :size="16" :number="3">
...
<template>
  <div class="ik-flex ik-flex-col ik-gap-4">
    <IkBadge outer :number="5">
      <span>Inbox</span>
    </IkBadge>
    <IkBadge outer design="success" :number="12">
...
The Badge component supports an `onClick` handler for interactive badges.
...
<template>
  <IkBadge 
    ...
    :onClick="handleClick"
  >
    <IkButton>Click Badge</IkButton>
  </IkBadge>
  <p class="ik-text--sm ik-mt-4">Clicked {{ clickCount }} times</p>
</template>
<script setup>
import { IkBadge } from '@ikol/ui-kit/components/IkBadge';
import { IkButton } from '@ikol/ui-kit/components/IkButton';
...
<template>
  <div class="ik-flex ik-gap-4 ik-items-center">
    <IkBadge :number="5" :show="isVisible">
