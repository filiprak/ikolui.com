...
<template>
  <IkFlex class="ik-pa-4" style="border: 1px dashed var(--border-neutral-regular-default);">
    <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Item 1</div>
    <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Item 2</div>
    <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Item 3</div>
  </IkFlex>
</template>
<script setup>
...
Control the flex direction using the `column` prop for vertical layouts.
...
<template>
  <IkFlex class="ik-pa-4" style="border: 1px dashed var(--border-neutral-regular-default); max-width: 300px;">
    ...
    <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Item 2</div>
    <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Item 3</div>
    <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Item 4</div>
    <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Item 5</div>
  </IkFlex>
</template>
<script setup>
import { IkFlex } from '@ikol/ui-kit/components/IkFlex';
...
<template>
  <IkFlex wrap_text class="ik-pa-4" style="border: 1px dashed var(--border-neutral-regular-default); max-width: 200px;">
    <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Very long text that should wrap</div>
    <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Another item</div>
  </IkFlex>
</template>
<script setup>
import { IkFlex } from '@ikol/ui-kit/components/IkFlex';
...
<template>
  <div>
    Text before
    <IkFlex inline class="ik-pa-2" style="border: 1px dashed var(--border-neutral-regular-default);">
      <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Item 1</div>
      <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Item 2</div>
    </IkFlex>
    Text after
...
<template>
  <IkFlex grow_and_fixed class="ik-pa-4" style="border: 1px dashed var(--border-neutral-regular-default);">
    <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Grows</div>
    <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Fixed</div>
    <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Fixed</div>
  </IkFlex>
</template>
<script setup>
...
Use the `tag` prop to render the flex container as a different HTML element.

```vue title="[[_Source code_]]" preview
<template>
  <IkFlex tag="section" class="ik-pa-4" style="border: 1px dashed var(--border-neutral-regular-default);">
    <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Item 1</div>
    <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Item 2</div>
  </IkFlex>
</template>
...
Use the `onClick` prop to handle click events on the flex container.
...
<template>
  <IkFlex 
    ...
    :onClick="handleClick"
  >
    <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Click me</div>
    <div class="ik-pa-2" style="background: var(--bg-primary-regular-default);">Item 2</div>
  </IkFlex>
...
const handleClick = () => {
  message.value = 'Flex container clicked!';
